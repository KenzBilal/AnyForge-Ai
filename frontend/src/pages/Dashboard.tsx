    ...
    <div className="p-4 md:p-8 max-w-7xl mx-auto space-y-8 pb-32">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
        ...
        <button 
          ...
          className="flex items-center justify-center bg-white text-black hover:bg-gray-200 px-5 py-2.5 rounded-lg font-bold transition-all glow-hover shadow-[0_0_20px_rgba(255,255,255,0.1)] active:scale-95"
        >
        ...
        <AnimatePresence>
          ...
          >
            ...
            <div className="flex items-center gap-3">
              <code className="bg-black/60 px-4 py-3 rounded-lg border border-white/10 text-lg text-emerald-300 font-mono flex-1 inline-block select-all shadow-inner">
                {newKeyData.api_key}
              </code>
              <button 
                onClick={() => copyToClipboard(newKeyData.api_key, "API Key")}
                className="bg-white/10 hover:bg-white/20 border border-white/10 p-3 rounded-lg text-white transition-colors active:scale-95"
              >
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="md:col-span-2 glass-panel rounded-2xl p-6 border border-white/5 relative overflow-hidden group">
  ...
  return (
    <div className="fixed inset-0 bg-black/80 backdrop-blur-md flex items-center justify-center z-50 p-4">
      <motion.div 
        ...
        className="glass-panel border-white/10 rounded-2xl w-full max-w-md overflow-hidden shadow-2xl"
      >
